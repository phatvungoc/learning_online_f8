...
export class OverviewService {
  ...
  postComment(hashCodeUser: string, hashCodeLession: string, content: string) {
    return this._http.post(
      'https://localhost:5001/api/1.0/Comment/comment-lession',
      {
        hashCodeUser: hashCodeUser,
        hashCodeLession: hashCodeLession,
        content,
